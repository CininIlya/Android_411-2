...
public class PlayingField5x5 extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView, int SelectedBoxPosition) {
        ...
        if (activePlayer == 1) {
            ...
            if (checkResults()) {
                com.example.gamexo.ResildDialog2 resildDialog2 = new com.example.gamexo.ResildDialog2(PlayingField5x5.this,
                ...
                com.example.gamexo.ResildDialog2 resildDialog2 = new com.example.gamexo.ResildDialog2(PlayingField5x5.this, "Match Draw", PlayingField5x5.this);
                resildDialog2.setCancelable(false);
                resildDialog2.show();
            } else {
